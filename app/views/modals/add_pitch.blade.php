<div class="modal fade" id="add_pitch_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add Pitch</h4>
            </div>
            ...
            <div class="modal-body">
                ...
                <input @keyup.enter="addPitchClicked" id="goal" type="text" class="form-control" placeholder="Enter goal" v-model="pitch.goal">
                ...
                <input @keyup.enter="addPitchClicked" id="deadline" type="text" class="form-control" placeholder="Enter deadline" v-model="pitch.deadline">
                ...
                <input @keyup.enter="addPitchClicked" id="video" type="text" class="form-control" placeholder="Enter video link" v-model="pitch.video">
                ...
                <input @keyup.enter="addPitchClicked" id="campaign" type="text" class="form-control" placeholder="Tell us about your beer" v-model="pitch.campaign">
                ...
                <input @keyup.enter="addPitchClicked" id="recipe" type="text" class="form-control" placeholder="Enter recipe" v-model="pitch.recipe">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" v-on:click="addPitchClicked">Add Pitch</button>
            </div>
