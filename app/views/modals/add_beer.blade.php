    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input @keyup.enter="addBeerClicked" id="brewery_id" type="text" class="form-control" placeholder="Enter brewery id" v-model="beer.brewery_id">
                ...
                <input @keyup.enter="addBeerClicked" id="category_id" type="text" class="form-control" placeholder="Enter category id" v-model="beer.category_id">
                ...
                <input @keyup.enter="addBeerClicked" id="style_id" type="text" class="form-control" placeholder="Enter style id" v-model="beer.style_id">
